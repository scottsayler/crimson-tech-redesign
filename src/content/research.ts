...
const legacyResearch: Research[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Technology evaluations drift when requirements are incomplete. Feature demos, ranking lists, and sales scripts can reshape priorities unless business and technical criteria are documented first.",
      "Independence is a process: document requirements, evaluate vendors against those criteria using a transparent methodology, and base recommendations on the results of that evaluation.",
      "Engagements start with requirements—call volumes, integration objects, compliance constraints, renewal timelines, and stakeholder success metrics. Vendors respond to criteria; criteria should not be rewritten after the first demo.",
      "A consistent facilitator runs scenario-based demos, scores finalists against the same scripts, and documents gaps for governance review. That process surfaces integration and contract issues early.",
      ...
      "The output is a recommendation leadership can defend: weighted scoring, shortlist rationale, migration phasing, and risks tied to evidence.",
      "Most advisory engagements can be funded by participating technology providers after a client selects a solution; fee-based engagements are also available when preferred. Either way, funding follows the decision—it does not rewrite the evaluation criteria.",
      "Publish your scoring model before demos, require scenario testing on your integrations and compliance rules, and keep requirements locked through finalist evaluation.",
    ],
